    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
                {/* Total Documents */}
                <TiltCard className="bg-white p-5 rounded-xl shadow-sm border border-gray-100 flex items-center justify-between transition hover:shadow-md h-full">
                    <div>
                        <p className="text-sm font-medium text-gray-500">Total Documents</p>
                        <p className="text-3xl font-bold text-gray-800 mt-1">{stats.total}</p>
                    </div>
                    <div className="p-3 bg-blue-50 rounded-full text-blue-600 shadow-sm">
                ...
                <TiltCard className="bg-white p-5 rounded-xl shadow-sm border border-gray-100 flex items-center justify-between transition hover:shadow-md h-full">
                    ...
                    <div className="p-3 bg-green-50 rounded-full text-green-600 shadow-sm">
                ...
                <TiltCard className="bg-white p-5 rounded-xl shadow-sm border border-gray-100 flex items-center justify-between transition hover:shadow-md h-full">
                    ...
                    <div className="p-3 bg-red-50 rounded-full text-red-600 shadow-sm">
                ...
                <TiltCard className="bg-white p-5 rounded-xl shadow-sm border border-gray-100 flex items-center justify-between transition hover:shadow-md h-full">
                    ...
                    <div className="p-3 bg-purple-50 rounded-full text-purple-600 shadow-sm">
